						...
						<table class="table table-sm v-middle">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<span class=" 
											@if($inscription->pagado())badge badge-success @endif
											@if($inscription->pagoParcial())badge badge-info @endif
											@if($inscription->pagoPendiente())badge badge-dark @endif
										">
											{{ $inscription->estado_del_pago }}</span>
									</td>
